 ...
 * @author prisc 
 */
public final class FrAltPacote extends javax.swing.JDialog {
    ...
    public FrAltPacote(java.awt.Frame parent, boolean modal, int id) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrAltPacote.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrAltPacote dialog = new FrAltPacote(new javax.swing.JFrame(), true, 1); // exemplo com id = 1
